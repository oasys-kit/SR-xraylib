...
def sync_ang(flag, angle_mrad, polarization=0, e_gev=1.0, i_a=0.001, hdiv_mrad=1.0, r_m=1.0, energy=1.0, ec_ev=1.0):
    """
...
def sync_ene(f_psi, energy_ev, ec_ev=1.0, polarization=0, e_gev=1.0, i_a=0.001, hdiv_mrad=1.0,
...
#------------------------- WIGGLER FUNCTIONS -----------------------------------
#
def wiggler_spectrum(traj, enerMin=1000.0, enerMax=100000.0, nPoints=100, per=0.2, electronCurrent=0.2,
...
def wiggler_cdf(traj, enerMin=10000.0, enerMax=10010.0, enerPoints=101, outFile="", elliptical=False):
    """
